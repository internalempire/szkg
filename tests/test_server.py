...
class ServerSecurityTests(unittest.TestCase):
    def test_viewer_configuration_is_public_but_other_data_is_not(self) -> None:
        ...
        self.assertTrue(is_public_path("/web/map-status.js"))
        self.assertTrue(is_public_path("/web/explorer.js"))
        self.assertTrue(is_public_path("/web/library.js"))
        self.assertTrue(is_public_path("/web/saved-views.js"))
